...
--
-- Este arquivo precisa continuar existindo: o remoto já pode ter a versão 026
-- na história. Sem ele, `db push` falha com "Remote migration versions not found".
-- Se a 026 aplicada no remoto for outra (sem bank_accounts), a 027/029 reparam.
