  ...
  if (!companyLoading && !company) {
    return (
      <div>
        ...
        <div className="mt-6">
          <CompanyRequired message="O realizado pertence à empresa do usuário autenticado. Crie ou selecione uma empresa para continuar." />
        </div>
      </div>
    )
  }
      ...
      <div className="flex flex-wrap items-end justify-between gap-4">
        <div>
          ...
          <p className="mt-2 max-w-2xl text-sm text-mist">
            Lance os valores que de fato aconteceram na{' '}
            <span className="font-medium text-ink-soft/80">
              {company?.trade_name || company?.name || 'sua empresa'}
            </span>
            . Cada realizado fica vinculado a um orçamento da mesma empresa.
          </p>
        </div>
