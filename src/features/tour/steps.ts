...
export const TOUR_STEPS: TourStep[] = [
  ...
  },
  {
    ...
    body: 'Aqui é onde você vai definir seu orçamento e decidir para onde seu dinheiro vai. Receitas, custos, despesas e investimentos — com destinos simples que você mesmo cria.',
  ...
  },
  {
    ...
    body: 'Aqui é onde você apropria as movimentações existentes nos quatro grupos: Receitas, Custos, Despesas ou Investimentos. Sem isso o dinheiro só entra; com isso, ele conta a história da operação.',
