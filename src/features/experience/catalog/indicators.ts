...
const agro = operational(['agro'], [
  { code: 'cost_per_hectare', name: 'Custo por hectare', unit: 'R$/ha', formula: 'custos / hectares', needUnits: ['hectare'], needAnswer: ['agro_tracks_cost_hectare', 'yes'] },
...
const livestock = operational(['livestock'], [
  ...
  { code: 'cost_per_head', name: 'Custo por cabeça', unit: 'R$', formula: 'custos / cabeças', needUnits: ['head'] },
...
const industry = operational(['industry'], [
  ...
  { code: 'cost_per_unit', name: 'Custo por unidade', unit: 'R$', formula: 'custo de produção / unidades', needUnits: ['produced_unit'] },
...
const construction = operational(['construction'], [
  ...
  { code: 'cost_per_sqm', name: 'Custo por m²', unit: 'R$/m²', formula: 'custos / m²', needUnits: ['sqm'] },
...
const transport = operational(['transport_logistics'], [
  { code: 'cost_per_km', name: 'Custo por km', unit: 'R$/km', formula: 'custos / km', needUnits: ['km'] },
...
const food = operational(['food'], [
  ...
  { code: 'cost_per_meal', name: 'Custo por refeição', unit: 'R$', formula: 'custos / refeições', needUnits: ['meal'] },
...
const services = operational(['services', 'professional'], [
  ...
  { code: 'cost_per_hour', name: 'Custo por hora', unit: 'R$/h', formula: 'custos / horas', needUnits: ['worked_hour'] },
...
const tech = operational(['tech'], [
  ...
  { code: 'cost_per_project_tech', name: 'Custo por projeto', unit: 'R$', formula: 'custos / projetos', needUnits: ['project'] },
  { code: 'cost_per_hour_tech', name: 'Custo por hora', unit: 'R$/h', formula: 'custos / horas', needUnits: ['worked_hour'] },
...
const education = operational(['education'], [
  { code: 'cost_per_student', name: 'Custo por aluno', unit: 'R$', formula: 'custos / alunos', needUnits: ['student'] },
...
const realEstate = operational(['real_estate'], [
  ...
  { code: 'cost_per_property', name: 'Custo por imóvel', unit: 'R$', formula: 'custos / imóveis', needUnits: ['property'] },
...
const automotive = operational(['automotive'], [
  { code: 'cost_per_service', name: 'Custo por serviço', unit: 'R$', formula: 'custos / serviços', needUnits: ['service'] },
...
const energy = operational(['energy'], [
  { code: 'cost_per_kwh', name: 'Custo por kWh', unit: 'R$/kWh', formula: 'custos / kWh', needUnits: ['kwh'] },
...
const mining = operational(['mining'], [
  { code: 'cost_per_ton_min', name: 'Custo por tonelada', unit: 'R$/t', formula: 'custos / toneladas', needUnits: ['ton'] },
...
const beauty = operational(['beauty'], [
  { code: 'cost_per_attendance', name: 'Custo por atendimento', unit: 'R$', formula: 'custos / atendimentos', needUnits: ['attendance'] },
...
const media = operational(['media', 'marketing'], [
  { code: 'cost_per_project_media', name: 'Custo por projeto', unit: 'R$', formula: 'custos / projetos', needUnits: ['project'] },
...
const play = operational(['entertainment', 'sports'], [
  { code: 'cost_per_event', name: 'Custo por evento', unit: 'R$', formula: 'custos / eventos', needUnits: ['event'] },
  { code: 'cost_per_client_play', name: 'Custo por cliente', unit: 'R$', formula: 'custos / clientes', needUnits: ['client'] },
...
const environment = operational(['environment'], [
  { code: 'cost_per_ton_env', name: 'Custo por tonelada', unit: 'R$/t', formula: 'custos / toneladas', needUnits: ['ton'] },
