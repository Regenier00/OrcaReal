...
export const ANALYSIS_UNITS: AnalysisUnitDef[] = [
  ...
  unit('kg', 'Kg produzido', FISH, 'Quilograma produzido'),
  ...
  unit('sold_unit', 'Produto vendido', COM, 'Produto vendido'),
  unit('category', 'Categoria', COM, 'Categoria de produtos'),
  unit('store', 'Loja', [...COM, ...FOOD, ...BEAU], 'Unidade comercial'),
  unit('sales_channel', 'Canal de venda', COM, 'Loja física, e-commerce ou marketplace'),
  ...
  unit('order', 'Pedido', [...FOOD, ...COM], 'Pedido realizado'),
  ...
  unit('attendance', 'Atendimento', [...BEAU, ...HLTH], 'Atendimento realizado'),
  unit('night', 'Diária', HOT, 'Diária realizada'),
  unit('operation', 'Operação', ['financial'], 'Operação financeira'),
  unit('public_service', 'Serviço realizado', PUB, 'Serviço prestado'),
  unit('operation_unit', 'Unidade de operação', ['other'], 'Unidade de operação'),
